...
<div style="width:850px; height:550px;overflow:auto;border:1px solid silver;position: relative; left: 0; top: 0;">
    ...
    <img src="<?php echo EXAMPLE_TMP_SERVERURL . 'image_D_' . $fileName; ?>" style="width:200px;position:absolute;top:280;left:40;z-index:100" />
    <img src="<?php echo EXAMPLE_TMP_SERVERURL . 'image_E_' . $fileName; ?>" style="width:200px;position:absolute;top:280;left:280;z-index:100" />
    <img src="<?php echo EXAMPLE_TMP_SERVERURL . 'image_F_' . $fileName; ?>" style="width:200px;position:absolute;top:280;left:520;z-index:100" />
</div>
<br /><br /><br />
